...
import dev.scx.app.util.ffi.win32.WinDef.RECT;
import dev.scx.app.util.ffi.win32.WinUser.WNDENUMPROC;
import dev.scx.ffi.ScxFFI;

import java.lang.foreign.MemorySegment;

import static dev.scx.app.util.ffi.win32.WinUser.POINT;
